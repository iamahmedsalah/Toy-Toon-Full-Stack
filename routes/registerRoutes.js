...
router.post('/',async (req, res)=>{
    ...
    try{
        ...
        const context = { UserName:`${user.name} ${user.Sname}`, verfied:`<a href="https://toy-toon.onrender.com/verifyUser?token=${user.emailToken}" target="_blank" style="font-size: 20px; font-family: Tillana , Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 30px; border: 1px solid #EE5007; display: inline-block; " > Verfiy</a>` };
